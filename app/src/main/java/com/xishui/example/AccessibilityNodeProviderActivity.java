...
public class AccessibilityNodeProviderActivity extends Activity {
    ...
    public static class VirtualSubtreeRootView extends View {
        ...
        public VirtualSubtreeRootView(Context context, AttributeSet attrs) {
            ...
            ViewCompat.setAccessibilityDelegate(this, new ExploreByTouchHelper(this) {
                @Override
...
//            return ViewCompat.getAccessibilityNodeProvider()
...
//        }
         ...
         */
        private class VirtualDescendantsProvider extends AccessibilityNodeProviderCompat {
            ...
            public AccessibilityNodeInfoCompat createAccessibilityNodeInfo(int virtualViewId) {
                ...
                if (virtualViewId == View.NO_ID) {
                    ...
                    info = AccessibilityNodeInfoCompat.obtain(VirtualSubtreeRootView.this);
...
//                    onInitializeAccessibilityNodeInfo(info);
            ...
            public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String searched,
                ...
                List<AccessibilityNodeInfoCompat> result = null;
                if (virtualViewId == View.NO_ID) {
                    ...
                    for (int i = 0; i < childCount; i++) {
                        ...
                        if (textToLowerCase.contains(searchedLowerCase)) {
                            if (result == null) {
                                result = new ArrayList<AccessibilityNodeInfoCompat>();
                            }
